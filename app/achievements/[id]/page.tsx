    ...
    return (
        <main className="min-h-screen bg-zinc-950 text-white selection:bg-indigo-500/30 pb-20">
            ...
            <div className="relative h-[50vh] w-full flex flex-col justify-center px-6 md:px-20 overflow-hidden">
                ...
                {/* Back Button (Anchors to #achievements) */}
            ...
            <div className="max-w-6xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-12">
                ...
                {/* RIGHT: Sidebar (Certificate & Skills) */}
                <div className="space-y-6">

                    {/* Certificate Preview Card */}
                    <div className="p-2 bg-white rounded-2xl rotate-2 hover:rotate-0 transition-transform duration-500 shadow-2xl">
                        <div className="relative aspect-[4/3] bg-zinc-200 rounded-xl overflow-hidden flex items-center justify-center text-zinc-400">
                            {/* Placeholder for now. Uncomment Image when ready */}
                            {/* <Image src={item.image} alt="Certificate" fill className="object-cover" /> */}
                            <span className="text-xs font-mono uppercase">Certificate Image</span>
                        </div>
                    </div>
